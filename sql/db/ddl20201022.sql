...
DETERMINISTIC
BEGIN
    DECLARE a_created, a_deleted, a_ordered, a_delivered, a_returned DATETIME;
    select created, deleted, ordered, delivered, returned
    into a_created, a_deleted, a_ordered, a_delivered, a_returned
...
BEGIN
SELECT *, order_status(order_id) as status
